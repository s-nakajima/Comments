...
<h2><?php echo __('Comment'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($comment['Comment']['plugin_key']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Content Key'); ?></dt>
		<dd>
			<?php echo h($comment['Comment']['content_key']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($comment['Comment']['created_user']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($comment['Comment']['modified_user']); ?>
			&nbsp;
		</dd>
