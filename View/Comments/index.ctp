<div class="comments index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('content_key'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($comment['Comment']['plugin_key']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['content_key']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['comment']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['created_user']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['created']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['modified_user']); ?>&nbsp;</td>
